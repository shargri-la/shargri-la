...
raw_data = pd.read_csv(f'{dirpath}/active_user_num.csv', header=None)
...
ax.cla()
ax.set_title('Number of Active Users in Each Shard Over Time')
ax.set_xlabel('Slot')
...
fig.savefig(f'{dirpath}/active_user_num.png')
